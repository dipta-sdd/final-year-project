        ...
        <nav aria-label="breadcrumb" class="mybg-t breadcrumb">
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <!-- <p><br><small>Please state your all academic degrees</small></p> -->
                    ...
                    <div class="row">
                      ...
                      <div class=" mb-3 col-lg-6">
                        <label class="my-color" for="floatingInput">Institute
                          <span class="text-danger">*</span></label>
                        <input type="number" class="form-control py-1 institute" name="institute" >
                      </div>
          ...
          <div class="row my-color mybg my-row" id="education">
            <div class="d-flex">
              ...
              <div>
                <button type="button" class="btn btn-outline-danger btn-add" id="btn-edit-profile" data-bs-toggle="modal" data-bs-target="#addEduModel">
                  <i class="fa-solid fa-plus me-2"> </i>Add Education
                </button>
                <button
                  type="button"
                  class="btn btn-outline-danger btn-save d-none"
                  id="btn-save"
                >
                  Save
                </button>
